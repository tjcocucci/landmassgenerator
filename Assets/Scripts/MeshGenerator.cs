...
{
    public static MeshData GenerateMeshData(float[,] heightMap, float heightMultiplier, AnimationCurve _animationCurve, int levelOfDetail, bool useFlatShading) {
